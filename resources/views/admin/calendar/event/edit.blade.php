                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form method="post" id='manageType'
                                    action="{{ route('admin.diary.event.update', $event->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions right" style="display: flex; justify-content: space-between;">
                                            <div class="left">
                                                @if ($event->recurrence != 'none')
                                                    <a href="#" data-modal="deleteEventRecurringModal"
                                                        data-action="{{ route('admin.diary.event.deleteAllRecurrences', $event->id) }}" style="background-color: #FF1616; color:white;" class="btn btn-outline clickDeleteFunction">
                                            ...
                                            <div class="right">
                                                <a href="#" data-modal="deleteEventModal"
                                                    data-action="{{ route('admin.diary.event.delete', $event->id) }}" style="background-color: #FF1616; color:white;" class="btn btn-outline clickDeleteFunction">
