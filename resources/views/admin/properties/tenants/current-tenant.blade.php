                        ...
                        <div class="card-content">
                            <div class="card-header">
                                <ul class="nav nav-tabs nav-underline no-hover-bg">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active disabled" id="currentTenant" data-toggle="tab"
                                            aria-controls="currentTenant" href="#currentTenant" aria-expanded="true">Current Tenant</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="{{ route('admin.properties.past.tenant', $property_id) }}">Past Tenant</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        <div class="container-fluid p-0 m-0">
                                            <div class="table-responsive">
                                                <table id="diaryTable" class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @php $j=1 @endphp
                                                        <?php
                                                            if($currentTenant->currentPage() !== 1){
                                                                $j =  10 * ( $currentTenant->currentPage() - 1) + 1;
                                                            }
                                                        ?>
                                                        @forelse ($currentTenant as $item)
                                                        <tr>
                                                            <td>{{ $j }}</td>
                                                            <td>
                                                                <a href="{{ route('admin.settings.tenants.edit', $item->id) }}">
                                                                    {{ $item->name }}
                                                                </a>
                                                            </td>                                                                                                                       
                                            ...
                                            <div class="row justify-content-center pagination-wrapper mt-2">
                                                {!! $currentTenant->appends(request()->query())->links('pagination::bootstrap-4') !!}
                                            </div>
                                        </div>
