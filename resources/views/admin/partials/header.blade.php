        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li style="margin-left: 0.25em;" class="nav-item mr-auto">
            <a class="navbar-brand" href="{{ url('/')}}">
              <img class="" style="max-width:150px" alt="modern admin logo" src="{{  \App\Helper\Helpers::get_logo_url('logo') }}">
            </a>
          </li>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link welcome_text_portal" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  <img src="{{ isset(Auth::guard('admin')->user()->profile->profile_image) ? asset('uploads/admin-' . Auth::guard('admin')->user()->id . '/' . Auth::guard('admin')->user()->profile->profile_image) : asset('/dashboard/images/avatar.png') }}" alt="avatar"><i></i></span>
              </a>
