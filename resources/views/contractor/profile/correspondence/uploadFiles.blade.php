            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('contractor.contractors.correspondence', $contractor->id) }}" class="theme-color">
                          Correspondence
                        </a>
                        </li>
...
@php 
    if($parent_id != 0) {
        $endRoute = route('contractor.contractors.correspondence.child', ['id' => $contractor->id, 'parent_id' => $parent_id]);
    } else {
        $endRoute = route('contractor.contractors.correspondence', ['id' => $contractor->id]);
    }
@endphp
...
<script>
        ...
        myDropzone = new Dropzone('.dropzone', { 
            ...
            timeout: 600000,
            maxFiles: 1,
            url: "{{ route('contractor.contractors.correspondence.uploadFiles', ['id' => $contractor->id, 'parent_id' => Request::segment(5)]) }}",
