...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">{{ $page['page_title'] }} | {{ $page['property_name'] }}</h3>
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}" class="theme-color">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.propertys.correspondence', $property->id) }}" class="theme-color">
                          Correspondence
                        </a>
                        </li>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id='uploadFiles' action="">
                                    ...
                                    <div class="form-actions left">
                                        <a href="<?php if($parent_id != 0) { echo route('admin.propertys.correspondence.child', ['id' => $property->id, 'parent_id' => $parent_id]); } else { echo route('admin.propertys.correspondence', ['id' => $property->id]); } ?>"
...
@php 
    if($parent_id != 0) {
        $endRoute = route('admin.propertys.correspondence.child', ['id' => $property->id, 'parent_id' => $parent_id]);
    } else {
        $endRoute = route('admin.propertys.correspondence', ['id' => $property->id]);
    }
@endphp
...
<script>
        ...
        myDropzone = new Dropzone('.dropzone', { 
            ...
            timeout: 600000,
            maxFiles: 1,
            url: "{{ route('admin.propertys.correspondence.uploadFiles', ['id' => $property->id, 'parent_id' => Request::segment(5)]) }}",
