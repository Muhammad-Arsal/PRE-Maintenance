(function ($) {
    ...
    function () {
      function FilterMultiSelect(selectTarget, args) {
        ...
        this.selectionCounter.hidden = true; // viewbar
      ...
      function () {
        function class_2(fms, row, name, label, value, checked, disabled) {
          ...
          this.closeButton.className = "closeButtonSelect";
          ...
          this.aTag.textContent = label;
          this.aTag.className = "multiselect-tags";
          this.aTag.setAttribute('data-id', value);
          this.selectedItemBadge.append(this.aTag);
