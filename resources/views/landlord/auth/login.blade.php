              ...
              <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="col-md-4 col-10 box-shadow-2 p-0">
                  <div class="card border-grey border-lighten-3 m-0">
                   ...
                   @endif
                        <form class="form-horizontal form-simple" id="loginForm" method="post" action="{{ route('landlordLogin')}}" >
                             @csrf
                          ...
                          <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6 col-12 text-center text-md-right"><a href="{{ route('landlord.showResetEmailForm') }}" class="card-link theme-color">Forgot Password?</a></div>
                          </div>
