...
class ContractorEmailVerifyNotification extends Notification

{
...

    {
        ...
        if($template){
            ...
            return (new MailMessage)
                    ->view(
                        'contractor.emails.verify-account',
                        [
    ...
    protected function verificationUrl($notifiable)
    {
        ...
        $contractor_id = $this->data->id;

        ContractorEmailVerification::create([
