                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form method="post" id='manageType'
                                    action="{{ route('contractor.diary.event.update', [$event->id, $contractor_id]) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions right" style="display: flex; justify-content: space-between;">
                                            <div class="left">
                                                @if ($event->recurrence != 'none')
                                                    <a href="#" data-modal="deleteEventRecurringModal"
                                                        data-action="{{ route('contractor.diary.event.deleteAllRecurrences', [$event->id,$contractor_id]) }}" style="background-color: #FF1616; color:white;" class="btn btn-outline clickDeleteFunction">
                                            ...
                                            <div class="right">
                                                <a href="#" data-modal="deleteEventModal"
                                                    data-action="{{ route('contractor.diary.event.delete',  [$event->id,$contractor_id]) }}" style="background-color: #FF1616; color:white;" class="btn btn-outline clickDeleteFunction">
                                                    ...
                                                    <td style="padding:1.9rem 2rem !important; vertical-align: middle;">
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="#" class="clickDeleteFunction" data-modal="perDeleteEventModal" data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                                                ...
                                                                data-action="{{ route('contractor.diary.event.fileDelete', [$row->id,$contractor_id]) }}"><span
