...
class ContractorEventController extends Controller
{
    ...
    public function create($contractorId) {
        ...
        return view('admin.contractors.calendar.event.add', compact('page', 'event_types', 'properties', 'contacts', 'contractor_id'));
    }
    ...
    public function store(Request $request, EventService $eventService, $contractorId) {
        ...
        return redirect()
        ->route( 'admin.contractors.calendar', ['savedState' => 'true', 'id' => $contractorId])
    ...
    public function edit(Events $id, $contractorId, $created_by_type = 'contractor') {
        ...
        return view('admin.contractors.calendar.event.edit', compact('page', 'event_types', 'properties', 'event', 'event_property', 'event_contacts', 'contacts', 'contractor_id'));
    }
    ...
    public function fileDelete(EventDocs $id, $contractorId)
    {
        ...
        return redirect()
        ->route('admin.contractors.diary.event.edit', [$eventDocs->event_id, $contractorId])
