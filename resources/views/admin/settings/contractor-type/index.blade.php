...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Contractor Types</h3>
        </div>
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{route('admin.settings.contractorType.create')}}" class="btn btn-primary basic-btn btn-min-width mr-1 mb-1">
                    <i class="la la-plus"></i> Add Contractor Type
                </a>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table custom-table">
                            ...
                            <tbody>
                                @foreach ($contractorTypes as $index => $type)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $type->name }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.settings.contractorType.edit', $type->id) }}" 
                                                data-toggle="tooltip" data-trigger="hover" data-placement="top" 
                                                data-title="Edit Contractor Type">
                                             ...
                                             <a href="#" class="clickDeleteFunction" 
                                                data-action="{{ route('admin.settings.contractorType.destroy', $type->id) }}" 
                                                data-toggle="tooltip" data-trigger="hover" data-placement="top" 
                                                data-title="Delete Contractor Type">
            ...
            <form name="deleteForm" action="" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Delete Contractor Type</h4>
