        ...
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('contractor.dashboard') }}" class="theme-color">Home</a>
                        </li>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id='managecontractor'  action="{{ route('contractor.profile.update') }}">
                                    @csrf
                                    <input type="hidden" name="contractor_id" value="{{ base64_encode($contractor->id) }}" />
                                    <div class="form-body">
                                        @php
                                          $name = explode(' ',$contractor->name );
                                        @endphp
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="text" id="phone_number" class="form-control"
                                                    placeholder="Phone number" name="phone_number" value="{{ old('phone_number') ? old('phone_number') : ( isset($contractor->profile->phone_number) ? $contractor->profile->phone_number : '' ) }}">
                                                <div class="form-control-position">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="email" id="email" class="form-control" placeholder="Email"
                                                    name="email" value="{{ old('email') ? old('email') : $contractor->email }}">
                                                <div class="form-control-position">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <select id="issueinput6" name="status" class="form-control"
                                                    ...
                                                    <option value="1" {{ $contractor->status->status == 1 ? 'selected' : '' }}>Active</option>
                                                    <option value="2" {{ $contractor->status->status == 2 ? 'selected' : '' }}>Inactive</option>
                                                </select>
                                                <div class="form-control-position">
                                                    <i class="la la-lock"></i>
                                                </div>
                                        ...
                                        <div class="form-actions right">
                                            {{-- <a href="{{ route('contractor.manage.users') }}" class="theme-btn btn btn-primary">
