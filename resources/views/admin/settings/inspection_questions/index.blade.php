    ...
    <div class="content-header row">
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{ route('admin.settings.inspectionQuestions.create') }}"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form id="searchForm" action="{{ route('admin.settings.inspectionQuestions.search') }}">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="{{ route('admin.settings.inspectionQuestions') }}" class="btn btn-primary basic-btn"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table mb-0 custom-table" id="manageTypes">
                                ...
                                <tbody>
                                    @php $j=1 @endphp
                                    <?php
                                        if($inspectionQuestions->currentPage() !== 1){
                                            $j =  10 * ( $inspectionQuestions->currentPage() - 1) + 1;
                                        }
                                    ?>
                                    @forelse($inspectionQuestions as $data)
                                        <tr>
                                            <td>{{ $j }}</td>
                                            <td>{{ $data['title'] }}</td>
                                            <td>{{ isset($data['created_at']) ? \Carbon\Carbon::parse($data['created_at'])->format('d/m/Y') : '' }}</td>
                                            <td style="width: 25%;">
                                                <a href="{{ route('admin.settings.inspectionQuestions.edit', $data->id) }}" data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                                    data-title="Edit Inspection Question"><span
                                                ...
                                                <a href="#" style="word-wrap: nowrap; margin-right: 0.35rem;" class="clickDeleteFunction" data-modal="forceDelete"
                                                    data-action="{{ route('admin.settings.inspectionQuestions.destroy', $data->id) }}"><span
                                                    style="padding:0.5rem 0.75rem" data-row-id="{{ $data->id }}"
                        ...
                        <div class="row justify-content-center pagination-wrapper mt-2">
                            {!! $inspectionQuestions->appends(request()->query())->links('pagination::bootstrap-4') !!}
                        </div>
                    </div>
                </div>
            </section>
                ...
                <form name="deleteForm" action="" method="post">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Delete Inspection Questions</h4>
