    ...
    <div class="content-header row">
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{ route('admin.settings.event-type.create') }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table mb-0 custom-table" id="manageTypes">
                            ...
                            <tbody>
                                @php $j=1 @endphp
                                @forelse($event_types as $data)
                                    <tr>
                                        <td>{{ $j }}</td>
                                        <td>{{ $data['event_name'] }}</td>
                                        <td>{{ isset($data['created_at']) ? date('d/m/Y', strtotime($data['created_at'])) : null }}
                                        </td>
                                        <td>
                                        <a href="{{ route('admin.settings.event-type.edit', ['id' => $data['id']]) }}" data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                            data-title="Edit Event Type"><span
                                            ...
                                            <a href="#" style="word-wrap: nowrap" class="clickDeleteFunction" data-modal="deleteEventModal"
                                                data-action="{{ route('admin.settings.event-type.destroy', ['id' => $data['id']]) }}" data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                                data-title="{{ isset($row['deleted_at']) ? 'Inactive Event Type' : 'Active Event Type' }}"><span
                                                    style="padding:0.5rem 0.75rem" data-row-id="{{ $data['id'] }}"
                ...
                <form name="deleteForm" action="" method="post">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Active/Inactive Event Type</h4>
