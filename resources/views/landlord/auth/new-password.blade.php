                            ...
                            <div class="col-md-4 col-10 box-shadow-2 p-0">
                                <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                    ...
                                    <div class="card-content mt-2">
                                        <div class="card-body">
                                            <form id="newPassword" method="post" action="{{ route('landlord.email.store', ['id' => $id, 'token' => $token]) }}">
                                                @csrf
                                    ...
                                    <div class="card-footer border-0">
                                        <p class="float-sm-left text-center btn btn-warning  btn-block btn-lg "><a href="{{ route('landlord.login') }}" class="card-link theme-color" style="color: white !important; "> Login</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="forget-password">
                        ...
                        <div class="pass-form">
                            ...
                            <form id="resetForm" method="post" action="{{ route('landlord.password.update') }}">
                                @csrf
