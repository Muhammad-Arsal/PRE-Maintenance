            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.tenants.correspondence', $tenant->id) }}" class="theme-color">
                          Correspondence
                        </a>
                        </li>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id='uploadFiles' action="">
                                    ...
                                    <div class="form-actions left">
                                        <a href="<?php if($parent_id != 0) { echo route('admin.tenants.correspondence.child', ['id' => $tenant->id, 'parent_id' => $parent_id]); } else { echo route('admin.tenants.correspondence', ['id' => $tenant->id]); } ?>"
...
@php 
    if($parent_id != 0) {
        $endRoute = route('admin.tenants.correspondence.child', ['id' => $tenant->id, 'parent_id' => $parent_id]);
    } else {
        $endRoute = route('admin.tenants.correspondence', ['id' => $tenant->id]);
    }
@endphp
...
<script>
        ...
        myDropzone = new Dropzone('.dropzone', { 
            ...
            timeout: 600000,
            maxFiles: 1,
            url: "{{ route('admin.tenants.correspondence.uploadFiles', ['id' => $tenant->id, 'parent_id' => Request::segment(5)]) }}",
