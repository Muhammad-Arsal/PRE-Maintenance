                                ...
                                <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                    <div class="card-header border-0 pb-0">
                                        <div class="card-title text-center" style="background: #041e41 !important;">
                                            <img src="{{ \App\Helper\Helpers::get_logo_url('logo') }}" alt="branding logo"
                                                style="max-width:100%">
                                        </div>
                                    </div>
                                    <div class="card-content mt-2">
                                        <div class="card-body">
                                            <form id="newPassword" method="post" action="{{ route('contractor.email.store', ['id' => $id, 'token' => $token]) }}">
                                                @csrf
                                                ...
                                                <button type="submit" class="theme-btn-outline btn btn-outline-info btn-lg btn-block"><i
                                                        class="ft-unlock"></i> Submit</button>
                                    ...
                                    <div class="card-footer border-0">
                                        <p class="float-sm-left text-center btn btn-warning  btn-block btn-lg "><a href="{{ route('contractor.login') }}" class="card-link theme-color" style="color: white !important; "> Login</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="forget-password">
                        ...
                        <div class="pass-form">
                            ...
                            <form id="resetForm" method="post" action="{{ route('contractor.password.update') }}">
                                @csrf
