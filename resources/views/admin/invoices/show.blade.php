    ...
    <div class="content-header row">
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{ route('admin.invoices.generatePDF', $invoice->id) }}"
                ...
                <table class="table table-bordered text-muted mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td class=""><a href="{{route('admin.properties.show',$invoice->property->id)}}">{{$invoice->property->line1 . ', ' . $invoice->property->city . ', ' . $invoice->property->county . ', ' . $invoice->property->postcode}}</a></td>
