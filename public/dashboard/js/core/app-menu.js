        ...
        bind_events: function() {
            ...
            function modernMenuExpand() {
                if ($body.data('menu') == 'vertical-menu-modern') {
                    ...
                    var navbar_brand = APP_URL + '/storage/logo/logo.png';
                    $('.header-navbar .navbar-brand img').attr('src', navbar_brand);
                    $('.header-navbar .navbar-brand img').css('max-width', '150px');
                ...
                if ($body.hasClass('menu-collapsed') && $body.data('menu') == 'vertical-menu-modern') {
                    setTimeout(function() {
                        if ($('.main-menu:hover').length === 0 && $('.navbar-header:hover').length === 0) {
                            ...
                            var navbar_brand = APP_URL + '/storage/logo/favicon.jpg';
                            $('.header-navbar .navbar-brand img').attr('src', navbar_brand);
                            $('.header-navbar .navbar-brand img').css('max-width', '23px');
                            if ($body.hasClass('menu-collapsed')) {
                                var $listItem = $('.main-menu li.open'),
                                    $subList = $listItem.children('ul');
                                $listItem.addClass('menu-collapsed-open');
