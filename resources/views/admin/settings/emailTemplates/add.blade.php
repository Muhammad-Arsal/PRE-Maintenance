                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data" id='manageEmailTemplate'
                                    action="{{ route('admin.emailTemplate.save') }}">
                                    @csrf
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" id="type" class="form-control {{ $errors->has('type') ? 'error' : '' }}"
                                                    placeholder="Email Type" name="type" value="{{ old('type') ? old('type') : '' }}" />
                                            </div>
                                            @if ($errors->has('type'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" id="subject" class="form-control {{ $errors->has('subject') ? 'error' : '' }}"
                                                    placeholder="Subject" name="subject" value="{{ old('subject') ? old('subject') : '' }}" />
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <select id="status" name="status" class="form-control {{ $errors->has('status') ? 'error' : '' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <select id="is_html" name="is_html" class="form-control {{ $errors->has('is_html') ? 'error' : '' }}"
                                                    data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                                    data-title="Html" data-original-title="" title="">
                                                    <option value="yes" >Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                            </div>
                                            @if ($errors->has('is_html'))
                                            <label id="is_html-error" class="error"
                                            for="is_html">{{ $errors->first('is_html') }}</label>
                                            @endif
                                        </div>
                                        <div class="form-group">
