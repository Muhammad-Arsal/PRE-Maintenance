                        ...
                        <div class="card-content">
                            <div class="card-header">
                                <ul class="nav nav-tabs nav-underline no-hover-bg">
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="{{ route('admin.settings.contractors', $contractor_id) }}">OverView</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" id='manageType'
                                    action="{{ route('admin.contractors.diary.event.update', [$event->id, $contractor_id]) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions right" style="display: flex; justify-content: space-between;">
                                            <div class="left">
                                                @if ($event->recurrence != 'none')
                                                    <a href="#" data-modal="deleteEventRecurringModal"
                                                        data-action="{{ route('admin.contractors.diary.event.deleteAllRecurrences', [$event->id,$contractor_id]) }}" style="background-color: #FF1616; color:white;" class="btn btn-outline clickDeleteFunction">
                                            ...
                                            <div class="right">
                                                <a href="#" data-modal="deleteEventModal"
                                                    data-action="{{ route('admin.contractors.diary.event.delete',  [$event->id,$contractor_id]) }}" style="background-color: #FF1616; color:white;" class="btn btn-outline clickDeleteFunction">
