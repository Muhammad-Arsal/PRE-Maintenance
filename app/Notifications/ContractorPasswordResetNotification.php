...
class ContractorPasswordResetNotification extends Notification
    ...
    public function toMail($notifiable)
    {
        ...
        if($template){
            ...
            return (new MailMessage)
                    ->view(
                        'contractor.emails.reset-password',
                        [
                            'token' => $originalToken,
                            'link' => config('app.url').route('contractor.showResetForm', ['token' => $this->token], false)."?email=".$originalToken,
            ...
            return (new MailMessage)
                        ...
                        url(config('app.url').route('contractor.showResetForm', ['token' => $this->token], false)."?email=".$originalToken))
