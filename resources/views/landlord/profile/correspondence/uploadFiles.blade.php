...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">{{ $page['page_title'] }} | {{ $page['landlord_name'] }}</h3>
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('landlord.dashboard') }}" class="theme-color">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('landlord.landlords.correspondence', $landlord->id) }}" class="theme-color">
                          Correspondence
                        </a>
                        </li>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id='uploadFiles' action="">
                                    ...
                                    <div class="form-actions left">
                                        <a href="<?php if($parent_id != 0) { echo route('landlord.landlords.correspondence.child', ['id' => $landlord->id, 'parent_id' => $parent_id]); } else { echo route('landlord.landlords.correspondence', ['id' => $landlord->id]); } ?>"
...
@php 
    if($parent_id != 0) {
        $endRoute = route('landlord.landlords.correspondence.child', ['id' => $landlord->id, 'parent_id' => $parent_id]);
    } else {
        $endRoute = route('landlord.landlords.correspondence', ['id' => $landlord->id]);
    }
@endphp
...
<script>
        ...
        myDropzone = new Dropzone('.dropzone', { 
            ...
            timeout: 600000,
            maxFiles: 1,
            url: "{{ route('landlord.landlords.correspondence.uploadFiles', ['id' => $landlord->id, 'parent_id' => Request::segment(5)]) }}",
