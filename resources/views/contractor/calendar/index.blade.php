    ...
    <div class="content-header row">
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{ route('contractor.diary.event.create', $contractor_id) }}" class="btn btn-primary basic-btn btn-min-width mr-1 mb-1"
                    type="button">
...
// calendar.render();
            ...
            function saveDateAndView(date, view) {
                $.ajax({
                    url: "{{ route('contractor.saveCalendarState') }}", 
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}', 
                        date: date,
