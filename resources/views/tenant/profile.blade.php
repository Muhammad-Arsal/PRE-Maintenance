                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id='managetenant'  action="{{ route('tenant.profile.update') }}">
                                    @csrf
                                    <input type="hidden" name="tenant_id" value="{{ base64_encode($tenant->id) }}" />
                                    <div class="form-body">
                                        @php
                                          $name = explode(' ',$tenant->name );
                                        @endphp
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="text" id="phone_number" class="form-control"
                                                    placeholder="Phone number" name="phone_number" value="{{ old('phone_number') ? old('phone_number') : ( isset($tenant->profile->phone_number) ? $tenant->profile->phone_number : '' ) }}">
                                                <div class="form-control-position">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="email" id="email" class="form-control" placeholder="Email"
                                                    name="email" value="{{ old('email') ? old('email') : $tenant->email }}">
                                                <div class="form-control-position">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <select id="issueinput6" name="status" class="form-control"
                                                    ...
                                                    <option value="1" {{ $tenant->status->status == 1 ? 'selected' : '' }}>Active</option>
                                                    <option value="2" {{ $tenant->status->status == 2 ? 'selected' : '' }}>Inactive</option>
                                                </select>
                                                <div class="form-control-position">
                                                    <i class="la la-lock"></i>
                                                </div>
                                        ...
                                        <div class="form-actions right">
                                            {{-- <a href="{{ route('tenant.manage.users') }}" class="theme-btn btn btn-primary">
