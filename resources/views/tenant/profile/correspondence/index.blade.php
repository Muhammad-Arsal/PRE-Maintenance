...
@section('content')
                                                            ...
                                                            <div class="form-group">
                                                                <div class="btn-group">
                                                                    <button type="submit" class="btn btn-primary basic-btn mr-1"
                                                                        ...
                                                                        Search</button>
                                                                    <a href="{{ route('tenant.tenants.correspondence', $tenant->id) }}" class="btn btn-primary basic-btn"
    ...
    <section id="manageTransactionsSection">
        <div class="card">
            <form id="delSubmit" action="{{ route('tenant.tenants.correspondence.delete', ['id' => $tenant->id]) }}"
                method="post">
                @csrf
                <div class="card-body" style="padding:0">
                        ...
                        <div class="1iconsContainer d-flex align-items-center">
                            <div class="" style="color:#fff">
                                <a data-target="#newComment" data-toggle="modal"
                                    data-action="{{ route('tenant.tenants.correspondence.ajax-add-comment', ['id' => $tenant->id]) }}"
                            ...
                            <div class="ml-1" style="color:#fff">
                                <a href="{{route('tenant.suppliers.correspondence.task', ['id' => $tenant->id])}}"
                    ...
                    <div class="options pb-2 pl-1 pr-1" style="display: flex;">
                        ...
                        <div data-target="" class="icons-cust mr-1" style="cursor: pointer">
                            ...
                            <a href="{{ route('tenant.tenants.correspondence.uploadFilesForm', ['id' => $tenant->id, 'parent_id' => $parent_id]) }}"
                                    ...
                                    @elseif(isset($d->name))
                                        <tr>
                                            ...
                                            <td style="width: 40%;"><a style="color: black; text-decoration: none;"
                                                href="{{ route('tenant.tenants.correspondence.child', ['id' => $tenant->id, 'parent_id' => $d['id']]) }}">{{ $d['name'] }}</a></td>
                                            <td style="wdith: 50%;">
                                                Folder
                                            </td>
                                        </tr>
                ...
                <div class="card-footer">
                    <div class="form-actions left">
                        <a href="<?php if ($parent->parent_id != 0) {
                            echo route('tenant.tenants.correspondence.child', ['id' => $tenant->id, 'parent_id' => $parent->parent_id]);
                        } else {
                            echo route('tenant.tenants.correspondence', ['id' => $tenant->id]);
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="<?php if (Request::segment(5)) {
                    echo route('tenant.tenants.correspondence.newFolder', ['id' => $tenant->id, 'parent_id' => Request::segment(5)]);
                } else {
                    echo route('tenant.tenants.correspondence.newFolder', ['id' => $tenant->id, 'parent_id' => 0]);
    ...
    <div class="modal" id="editDescriptionFilesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" action="{{ route('tenant.tenants.correspondence.add-edit-description', ['id' => $tenant->id]) }}" class="editDescriptionForm" id="editDescriptionForm">
                    @csrf
                    <div class="modal-header">
    ...
    <div class="modal" id="editCommentModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" action="<?php echo route('tenant.tenants.correspondence.ajax-edit-comment', $tenant->id) ?>" class="editCommentForm" id="editCommentForm">
                    <div class="modal-header">
    ...
    <div class="modal" id="moveFile" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="<?php if (Request::segment(5)) {
                    echo route('tenant.tenants.correspondence.moveFile', ['id' => $tenant->id, 'parent_id' => Request::segment(5)]);
                } else {
                    echo route('tenant.tenants.correspondence.moveFile', ['id' => $tenant->id, 'parent_id' => 0]);
    ...
    <div class="modal" id="copyToFilesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('tenant.tenants.correspondence.fileVault', $tenant->id) }}" id="copy_to_files" method="post">
                    <div class="modal-header">
    ...
    <div class="modal" id="feeEntryModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('tenant.tenants.correspondence.newCall', ['id' => $tenant->id, 'parent_id' => $parent_id]) }}" id="feeTypeForm"
                    method="post">
                    <div class="modal-header">
    ...
    <div class="modal" id="meetingModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('tenant.tenants.correspondence.newMeeting', ['id' => $tenant->id, 'parent_id' => $parent_id]) }}" id="meetingForm"
                    method="post">
                    <div class="modal-header">
