                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id='managelandlord'  action="{{ route('landlord.profile.update') }}">
                                    @csrf
                                    <input type="hidden" name="landlord_id" value="{{ base64_encode($landlord->id) }}" />
                                    <div class="form-body">
                                        @php
                                          $name = explode(' ',$landlord->name );
                                        @endphp
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="text" id="phone_number" class="form-control"
                                                    placeholder="Phone number" name="phone_number" value="{{ old('phone_number') ? old('phone_number') : ( isset($landlord->profile->phone_number) ? $landlord->profile->phone_number : '' ) }}">
                                                <div class="form-control-position">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="email" id="email" class="form-control" placeholder="Email"
                                                    name="email" value="{{ old('email') ? old('email') : $landlord->email }}">
                                                <div class="form-control-position">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <select id="issueinput6" name="status" class="form-control"
                                                    ...
                                                    <option value="1" {{ $landlord->status->status == 1 ? 'selected' : '' }}>Active</option>
                                                    <option value="2" {{ $landlord->status->status == 2 ? 'selected' : '' }}>Inactive</option>
                                                </select>
                                                <div class="form-control-position">
                                                    <i class="la la-lock"></i>
                                                </div>
                                        ...
                                        <div class="form-actions right">
                                            {{-- <a href="{{ route('landlord.manage.users') }}" class="theme-btn btn btn-primary">
