                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form method="post" id='manageType'
                                    action="{{ route('admin.settings.event-type.update', $event_type->id) }}">
                                    @csrf
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" id="event_name" class="form-control {{ $errors->has('event_name') ? 'error' : '' }}"
                                                    placeholder="Event Name" name="event_name" value="{{ old('event_name') ? old('event_name') : $event_type->event_name }}" />
                                            </div>
                                            ...
                                            <div class="position-relative">
                                                <select class="form-control {{ $errors->has('email_template') ? 'error' : '' }}" name="email_template" id="email_template">
                                                    ...
                                                    @foreach ($emailTemplates as $item)
                                                        <option {{ $item->id == $event_type->email_template_id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->type }}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
