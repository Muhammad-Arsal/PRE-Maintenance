...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 breadcrumb-new">
            <h3 class="mb-0 d-inline-block">{{ $page['page_title'] }} | {{ $page['contractor_name'] }}</h3>
        </div>
    </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="btn-group">
                                                                    <button type="submit" class="btn btn-primary basic-btn mr-1"
                                                                        ...
                                                                        Search</button>
                                                                    <a href="{{ route('contractor.contractors.correspondence', $contractor->id) }}" class="btn btn-primary basic-btn"
    ...
    <section id="manageTransactionsSection">
        <div class="card">
            <form id="delSubmit" action="{{ route('contractor.contractors.correspondence.delete', ['id' => $contractor->id]) }}"
                method="post">
                @csrf
                <div class="card-body" style="padding:0">
                        ...
                        <div class="1iconsContainer d-flex align-items-center">
                            <div class="" style="color:#fff">
                                <a data-target="#newComment" data-toggle="modal"
                                    data-action="{{ route('contractor.contractors.correspondence.ajax-add-comment', ['id' => $contractor->id]) }}"
                            ...
                            <div class="ml-1" style="color:#fff">
                                <a href="{{route('contractor.suppliers.correspondence.task', ['id' => $contractor->id])}}"
                    ...
                    <div class="options pb-2 pl-1 pr-1" style="display: flex;">
                        ...
                        <div data-target="" class="icons-cust mr-1" style="cursor: pointer">
                            ...
                            <a href="{{ route('contractor.contractors.correspondence.uploadFilesForm', ['id' => $contractor->id, 'parent_id' => $parent_id]) }}"
                                    ...
                                    @elseif(isset($d->name))
                                        <tr>
                                            ...
                                            <td style="width: 40%;"><a style="color: black; text-decoration: none;"
                                                href="{{ route('contractor.contractors.correspondence.child', ['id' => $contractor->id, 'parent_id' => $d['id']]) }}">{{ $d['name'] }}</a></td>
                                            <td style="wdith: 50%;">
                                                Folder
                                            </td>
                                        </tr>
                ...
                <div class="card-footer">
                    <div class="form-actions left">
                        <a href="<?php if ($parent->parent_id != 0) {
                            echo route('contractor.contractors.correspondence.child', ['id' => $contractor->id, 'parent_id' => $parent->parent_id]);
                        } else {
                            echo route('contractor.contractors.correspondence', ['id' => $contractor->id]);
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="<?php if (Request::segment(5)) {
                    echo route('contractor.contractors.correspondence.newFolder', ['id' => $contractor->id, 'parent_id' => Request::segment(5)]);
                } else {
                    echo route('contractor.contractors.correspondence.newFolder', ['id' => $contractor->id, 'parent_id' => 0]);
    ...
    <div class="modal" id="editDescriptionFilesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" action="{{ route('contractor.contractors.correspondence.add-edit-description', ['id' => $contractor->id]) }}" class="editDescriptionForm" id="editDescriptionForm">
                    @csrf
                    <div class="modal-header">
    ...
    <div class="modal" id="editCommentModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" action="<?php echo route('contractor.contractors.correspondence.ajax-edit-comment', $contractor->id) ?>" class="editCommentForm" id="editCommentForm">
                    <div class="modal-header">
    ...
    <div class="modal" id="moveFile" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="<?php if (Request::segment(5)) {
                    echo route('contractor.contractors.correspondence.moveFile', ['id' => $contractor->id, 'parent_id' => Request::segment(5)]);
                } else {
                    echo route('contractor.contractors.correspondence.moveFile', ['id' => $contractor->id, 'parent_id' => 0]);
    ...
    {{-- <div class="modal" id="copyToFilesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('contractor.contractors.correspondence.fileVault', $contractor->id) }}" id="copy_to_files" method="post">
                    <div class="modal-header">
    ...
    {{-- <div class="modal" id="copyToCrossModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{route('contractor.corres.add', ['id' => $contractor->id])}}" id="copy_to_cross" method="post">
                    @csrf
                    <div class="modal-header">
    ...
    <div class="modal" id="feeEntryModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('contractor.contractors.correspondence.newCall', ['id' => $contractor->id, 'parent_id' => $parent_id]) }}" id="feeTypeForm"
                    method="post">
                    <div class="modal-header">
    ...
    <div class="modal" id="meetingModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('contractor.contractors.correspondence.newMeeting', ['id' => $contractor->id, 'parent_id' => $parent_id]) }}" id="meetingForm"
                    method="post">
                    <div class="modal-header">
