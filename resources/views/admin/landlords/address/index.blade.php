                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id='managelandlord' action="{{ route('admin.settings.landlord.address.store', $landlord->id) }}">
                                    @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <select id="overseas_landlord" name="overseas_landlord" class="form-control"
                                                            ...
                                                            <option value="Yes" {{ $landlord->overseas_landlord == 'Yes' ? 'selected' : '' }}>Yes</option>
                                                            <option value="No" {{ $landlord->overseas_landlord == 'No' ? 'selected' : '' }}>No</option>
                                                        </select>
                                                        <div class="form-control-position">
                                                            <i class="la la-globe"></i>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="tax_exemption_code" class="form-control"
                                                            name="tax_exemption_code" value="{{ $landlord->tax_exemption_code }}">
                                                        <div class="form-control-position">
