...
@section('content')
                                                            ...
                                                            <div class="form-group">
                                                                <div class="btn-group">
                                                                    <button type="submit" class="btn btn-primary basic-btn mr-1"
                                                                        ...
                                                                        Search</button>
                                                                    <a href="{{ route('landlord.landlords.correspondence', $landlord->id) }}" class="btn btn-primary basic-btn"
    ...
    <section id="manageTransactionsSection">
        <div class="card">
            <form id="delSubmit" action="{{ route('landlord.landlords.correspondence.delete', ['id' => $landlord->id]) }}"
                method="post">
                @csrf
                <div class="card-body" style="padding:0">
                        ...
                        <div class="1iconsContainer d-flex align-items-center">
                            <div class="" style="color:#fff">
                                <a data-target="#newComment" data-toggle="modal"
                                    data-action="{{ route('landlord.landlords.correspondence.ajax-add-comment', ['id' => $landlord->id]) }}"
                            ...
                            <div class="ml-1" style="color:#fff">
                                <a href="{{route('landlord.suppliers.correspondence.task', ['id' => $landlord->id])}}"
                    ...
                    <div class="options pb-2 pl-1 pr-1" style="display: flex;">
                        ...
                        <div data-target="" class="icons-cust mr-1" style="cursor: pointer">
                            ...
                            <a href="{{ route('landlord.landlords.correspondence.uploadFilesForm', ['id' => $landlord->id, 'parent_id' => $parent_id]) }}"
                                    ...
                                    @elseif(isset($d->name))
                                        <tr>
                                            ...
                                            <td style="width: 40%;"><a style="color: black; text-decoration: none;"
                                                href="{{ route('landlord.landlords.correspondence.child', ['id' => $landlord->id, 'parent_id' => $d['id']]) }}">{{ $d['name'] }}</a></td>
                                            <td style="wdith: 50%;">
                                                Folder
                                            </td>
                                        </tr>
                ...
                <div class="card-footer">
                    <div class="form-actions left">
                        <a href="<?php if ($parent->parent_id != 0) {
                            echo route('landlord.landlords.correspondence.child', ['id' => $landlord->id, 'parent_id' => $parent->parent_id]);
                        } else {
                            echo route('landlord.landlords.correspondence', ['id' => $landlord->id]);
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="<?php if (Request::segment(5)) {
                    echo route('landlord.landlords.correspondence.newFolder', ['id' => $landlord->id, 'parent_id' => Request::segment(5)]);
                } else {
                    echo route('landlord.landlords.correspondence.newFolder', ['id' => $landlord->id, 'parent_id' => 0]);
    ...
    <div class="modal" id="editDescriptionFilesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" action="{{ route('landlord.landlords.correspondence.add-edit-description', ['id' => $landlord->id]) }}" class="editDescriptionForm" id="editDescriptionForm">
                    @csrf
                    <div class="modal-header">
    ...
    <div class="modal" id="editCommentModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" action="<?php echo route('landlord.landlords.correspondence.ajax-edit-comment', $landlord->id) ?>" class="editCommentForm" id="editCommentForm">
                    <div class="modal-header">
    ...
    <div class="modal" id="moveFile" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="<?php if (Request::segment(5)) {
                    echo route('landlord.landlords.correspondence.moveFile', ['id' => $landlord->id, 'parent_id' => Request::segment(5)]);
                } else {
                    echo route('landlord.landlords.correspondence.moveFile', ['id' => $landlord->id, 'parent_id' => 0]);
    ...
    {{-- <div class="modal" id="copyToFilesModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('landlord.landlords.correspondence.fileVault', $landlord->id) }}" id="copy_to_files" method="post">
                    <div class="modal-header">
    ...
    <div class="modal" id="feeEntryModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('landlord.landlords.correspondence.newCall', ['id' => $landlord->id, 'parent_id' => $parent_id]) }}" id="feeTypeForm"
                    method="post">
                    <div class="modal-header">
    ...
    <div class="modal" id="meetingModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('landlord.landlords.correspondence.newMeeting', ['id' => $landlord->id, 'parent_id' => $parent_id]) }}" id="meetingForm"
                    method="post">
                    <div class="modal-header">
