                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form method="post" id='manageType' enctype="multipart/form-data"
                                    action="{{ route('contractor.diary.event.store', $contractor_id) }}">
                                    @csrf
                                    <div class="form-body">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <select name="contacts[]" multiple id="contacts" class="form-control">
                                                            @foreach ($contacts as $contact)
                                                                <option @if ($contact->id == $contractor_id)
                                                                    selected
                                                                    
                                                                @endif value="{{ $contact->id }}">{{ $contact->name . ' ' . (!empty($contact->contactType) ? '(' . $contact->contactType->name . ')' : '') }}</option>
                                                            @endforeach
                                                        </select>
                                                        <div class="form-control-position">
                                        ...
                                        <div class="form-actions right">
                                            <a href="{{ route('contractor.calendar', ['savedState' => 'true', $contractor_id]) }}" class="theme-btn btn btn-primary">
