                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form id="searchForm" action="{{route('tenant.invoices.search')}}">
                                        <div class="form-body">
                                            <div class="row">
                                ...
                                <tbody>
                                    ...
                                    @forelse($invoices as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('tenant.invoices.show', $data->id)}}" 
                                                ...
                                                {{-- <a href="{{route('tenant.invoices.edit', $data->id)}}" data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                                ...
                                                <a href="#" style="word-wrap: nowrap; margin-right: 0.35rem;" 
                                                    ...
                                                    data-action="{{ route('tenant.invoices.destroy', $data->id) }}" 
                                                    data-row-id="{{ $data->id }}">
