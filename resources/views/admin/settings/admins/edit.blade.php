                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data" id='manageAdmin' action="{{ route('admin.settings.admins.update', $admin->id) }}">
                                    @csrf
                                    @method('PUT')
                                    @php $name = explode(" ", $admin->name); @endphp
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="text" id="phone_number" class="form-control" placeholder="Phone number" name="phone_number" value="{{ old('phone_number', $admin->profile->phone_number) }}">
                                                <div class="form-control-position">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="email" id="email" class="form-control" placeholder="Email" name="email" value="{{ old('email', $admin->email) }}">
                                                <div class="form-control-position">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <select id="status" name="status" class="form-control">
                                                    <option value="Active" {{ old('status', is_null($admin->deleted_at) ? 'Active' : '') == 'Active' ? 'selected' : '' }}>Active</option>
                                                    <option value="Inactive" {{ old('status', !is_null($admin->deleted_at) ? 'Inactive' : '') == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                                                </select>
                                                <div class="form-control-position">
                                                    <i class="la la-lock"></i>
                                                </div>
                                        ...
                                        <div class="form-actions right">
                                            <a href="{{ route('admin.settings.admins') }}" class="theme-btn btn btn-primary">
