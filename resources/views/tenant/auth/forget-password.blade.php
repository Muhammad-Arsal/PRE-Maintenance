                            ...
                            <div class="col-md-4 col-10 box-shadow-2 p-0">
                                <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form-horizontal" id="forgetPasswordForm" method="post"
                                                action="{{ route('tenant.forgetSendEmail') }}">
                                                @csrf
                                    ...
                                    <div class="card-footer border-0" style="padding-top: 0px !important;">
                                        <a href="{{ route('tenant.login') }}" class="card-link theme-color float-sm-left text-center btn btn-warning  btn-block btn-lg " style="color: white !important; "> Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
