    ...
    <div class="content-header row">
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{ route('admin.settings.landlords.create') }}"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form id="searchForm" action="{{ route('admin.settings.landlords.search') }}">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="{{ route('admin.settings.landlords') }}" class="btn btn-primary basic-btn"
                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @forelse($landlords as $data)
                                        <tr>
                                            ...
                                            <td style="width: 25%;">
                                                <a href="{{ route('admin.settings.landlords.edit', ['id' => $data['id']]) }}" data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                                ...
                                                {{-- <a href="#" style="word-wrap: nowrap" class="clickDeleteFunction" data-modal="deleteEventModal"
                                                    data-action="{{ route('admin.settings.landlords.destroy', ['id' => $data['id']]) }}" data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                                    data-title="{{ isset($data['deleted_at']) ? 'Inactive landlord' : 'Active landlord' }}"><span
                                                        style="padding:0.5rem 0.75rem" data-row-id="{{ $data['id'] }}"
                                                ...
                                                <a href="#" style="word-wrap: nowrap; margin-right: 0.35rem;" class="clickDeleteFunction" data-modal="forceDelete"
                                                    data-action="{{ route('admin.settings.landlords.delete', ['id' => $data['id']]) }}"><span
                                                    style="padding:0.5rem 0.75rem" data-row-id="{{ $data['id'] }}"
                        ...
                        <div class="row justify-content-center pagination-wrapper mt-2">
                            {!! $landlords->appends(request()->query())->links('pagination::bootstrap-4') !!}
                        </div>
                    </div>
                </div>
            </section>
                ...
                <form name="deleteForm" action="" method="post">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Active/Inactive landlord</h4>
